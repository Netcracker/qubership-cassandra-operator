...
{{- define "cassandra.monitoredImages" -}}
  {{- if .Values.deployDescriptor -}}
    ...
    {{- if .Values.cassandra.install -}}
      {{- printf "statefulset cassandra0 cassandra0 %s, " (include "find_image" (dict "deployName" "dockerCassandra" "SERVICE_NAME" "docker-cassandra" "vals" .Values "default" "not_found")) -}}
