...
func main() {
	...
	apiUser := mUtils.GetSecret("/var/run/secrets/dbaas-aggregator/username", "dbaas-adapter")
	apiPass := mUtils.GetSecret("/var/run/secrets/mongodb/dbaas-aggregator/password", "dbaas-adapter")
